...
describe('favorite blog', () => {
  ...
  test('of empty list is null', () => {
    assert.deepStrictEqual(listHelper.favoriteBlog(emptyBlog), null)
  })
...
describe('mostBlogs', () => {
  ...
  test('of empty list is null', () => {
    assert.deepStrictEqual(listHelper.mostBlogs(emptyBlog), null)
  })
...
describe('mostLikes', () => {
  ...
  test('of empty list is null', () => {
    assert.deepStrictEqual(listHelper.mostLikes(emptyBlog), null)
  })
